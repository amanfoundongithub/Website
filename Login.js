...
const Login = () => {
    ...
    return (
        <div style={myStyle} >
            ...
            <Grid container align={"justify"} item xs={12} style={{ paddingLeft: '30px' ,paddingLeft: "10px", paddingTop:"180px" }}>
                {/* <div style={{}}> */}
                    <Button
                        variant="contained"
                ...
                <Grid container align={"justify"} item xs={12} style={{paddingBottom: '20px',justifyContent:'right' }}>
                {/* <div style={{}}> */}
                    <Button
                        variant="contained"
